...
RUN apt-get update && \
    apt-get install -y unzip curl libx11-6 libxext6 libxcb1 libglib2.0-0 libnss3 libdbus-1-3 libatk1.0-0 libatk-bridge2.0-0 libcups2 libgdk-pixbuf2.0-0 libgtk-3-0 libgbm1 libasound2 libxcomposite1 libxdamage1 libxfixes3 libxrandr2 libdrm2 libxkbcommon0 libatspi2.0-0 libpango-1.0-0 libcairo2 libexpat1 && \
